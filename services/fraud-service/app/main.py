"""FastAPI application entry point for Fraud Detection Service."""

from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware

from app.config import settings
from app.routers import fraud_router

app = FastAPI(
    title="Fraud Detection Service",
    description="AI-powered fraud analysis using Amazon Bedrock (Claude Sonnet 4.5)",
    version="1.0.0",
)
